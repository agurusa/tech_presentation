...
EXCEPT_OFF = 'Simulation has not started to spin the generator.'
...
class HydroGen:  # CRUISING300, 200 MM
    def __init__(self):
        ...
        self.manufacture_version = choice(specs.VERSION_MAN, 1, p=[0.1, 0.9])[0]   # probability based on order date
